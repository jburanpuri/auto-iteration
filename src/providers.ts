...
Assess non-spam relevance from the actual content: concrete product behavior, reproduction details, unsolicited promotion, malicious links, and relevance to the product. Apply the same content assessment to authored samples and submitted feedback. Write each confidence reason as one short, complete sentence about content relevance or code evidence; keep sample provenance in metadata rather than repeating it in this reason. Sample origin is provenance, not a spam score. Do not infer verified identity or real-world prevalence from samples. Repeated or synthetic reports do not increase confidence.
